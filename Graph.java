...
public class Graph {
	...
	public void initialize(File source) throws Exception {
		...
		// Scanner sc closed at the end of initialize(), so there is not a resource
		// leak.
		// @SuppressWarnings("resource")
		// Scanner sc = new Scanner(System.in);
		Scanner sc = new Scanner(source);
		/*
		 * System.out.print("Input the path name for the file:"); try { file = new
		 * File(sc.nextLine()); sc = new Scanner(file); b = false; }
		 * catch(FileNotFoundException e) { throw new
		 * FileNotFoundException("Incorrect file pathname."); }
		 */
		...
		// Reads the number of vertices to follow. Initializes the array, vertices, to
		...
		// Reads the number of edges to follow. Initializes the array, edges, to the
		// number of edges.
		num = sc.nextInt();
		edges = new Edge[num];
		sc.nextLine();
		...
		// Reads the number of regions to follow. Initializes the array, regions, to the
		// number of regions.
		num = sc.nextInt();
		...
		adjacencyList();
		System.out.println("Adjacency list has been sucessfully initialized.\n");
